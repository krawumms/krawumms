...
const Search: FunctionComponent<Props> = () => {
  ...
  return (
    <Box padding="16px" display="flex" width="100%" flexDirection="column" alignItems="center" justifyContent="center">
      ...
      {!isLoading && query && !tracks?.length && (
        <Box padding="16px" display="flex" flex="1" flexDirection="column" justifyContent="center" alignItems="center">
